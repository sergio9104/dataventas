...
export default class InformeDiario extends React.Component {
	...
	getData() {
		...
		request("consumos_" + ambiente + "/consultaventascomercio-" + ambiente, { idComercio: this.props.navigation.getParam('IdComercio'), m: 8, periodo: "D" }, (res) => {
			res.then((res) => {
		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.title}>
					<TouchableOpacity onPress={() => this.props.navigation.navigate("INFORME DIARIO DETALLE", { date: this.props.navigation.getParam('date')})}><Text> <Icon name="ios-arrow-back" size={26} color='#FFF' /></Text></TouchableOpacity><View style={{ flexDirection: "row" }}><Image source={require('../../icons/ICONO-INFORME-DIARIO.png')} /><Text style={styles.texttitle}>INFORME DIARIO</Text></View><View></View>
				</View>
