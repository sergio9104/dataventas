...
export default class DetalleVentasGrupoMensual extends React.Component {
	constructor() {
		super();
		this.state = {
			showGraph: false,
	...
	render() {
		return (
			<View style={styles.container}>
				...
				<TouchableOpacity onPress={() => this.props.navigation.navigate("INFORME MENSUAL")}><Text> <Icon name="ios-arrow-back" size={26} color='#FFF' /></Text></TouchableOpacity><View style={{flexDirection:"row"}}><Image source={require('../../icons/ICONO-INFORME-MENSUAL.png')} /><Text style={styles.texttitle}>INFORME MENSUAL</Text></View><View></View>
				</View>
