...
export default class VentasComercioMensual extends React.Component {
	constructor() {
		super();
		this.state = {
			showGraph: false,
	...
	getData() {
		...
		request("consumos_" + ambiente + "/consultaventascomercio-" + ambiente, { idComercio: this.props.navigation.getParam('IdComercio'), m: 4, periodo: "M" }, (res) => {
			res.then((res) => {
		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.title}>
					<TouchableOpacity onPress={() => this.props.navigation.navigate("INFORME DETALLE MENSUAL", { date: this.props.navigation.getParam('date')})}><Text> <Icon name="ios-arrow-back" size={26} color='#FFF' /></Text></TouchableOpacity><View style={{ flexDirection: "row" }}><Image source={require('../../icons/ICONO-INFORME-MENSUAL.png')} /><Text style={styles.texttitle}>INFORME MENSUAL</Text></View><View></View>
				</View>
